...
------------ | ------------- | ------------- | -------------
*AnalyzeAPI* | [**AnalyzeCreate**](docs/AnalyzeAPI.md#analyzecreate) | **Post** /api/analyze | 
...
*JobsAPI* | [**JobsPartialUpdate**](docs/JobsAPI.md#jobspartialupdate) | **Patch** /api/jobs/{job_id}/ | 
...
## Documentation For Models
 ...
 - [AnalyzeGetRequest](docs/AnalyzeGetRequest.md)
 - [AnalyzeGetResponse](docs/AnalyzeGetResponse.md)
 - [AnalyzerResult](docs/AnalyzerResult.md)
 ...
 - [PatchedJobUpdateRequest](docs/PatchedJobUpdateRequest.md)
 ...
 - [WorkloadTypeEnum](docs/WorkloadTypeEnum.md)
