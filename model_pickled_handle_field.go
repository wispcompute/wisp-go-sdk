...
type _PickledHandleField PickledHandleField
...
func (o *PickledHandleField) UnmarshalJSON(data []byte) (err error) {
	...
	varPickledHandleField := _PickledHandleField{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPickledHandleField)

	if err != nil {
		return err
	}

	*o = PickledHandleField(varPickledHandleField)
