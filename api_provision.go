...
func (r ApiProvisionRetrieveRequest) Execute() (*ProvisionLog, *http.Response, error) {
	return r.ApiService.ProvisionRetrieveExecute(r)
}
...
func (a *ProvisionAPIService) ProvisionRetrieveExecute(r ApiProvisionRetrieveRequest) (*ProvisionLog, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *ProvisionLog
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProvisionAPIService.ProvisionRetrieve")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/provision/{provision_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"provision_id"+"}", url.PathEscape(parameterValueToString(r.provisionId, "provisionId")), -1)
