...
func (r ApiConstraintsPartialUpdateRequest) Execute() (*ConstrainResponse, *http.Response, error) {
...
// Execute executes the request
//  @return ConstrainResponse
func (a *ConstraintsAPIService) ConstraintsPartialUpdateExecute(r ApiConstraintsPartialUpdateRequest) (*ConstrainResponse, *http.Response, error) {
	var (
